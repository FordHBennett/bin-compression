...
public:
    // Constructors
    LZW_Stats();
    LZW_Stats(double avgSizeBytes, double average_time_encoded_in_s , double average_time_decoded_in_s , double average_compression_ratio, size_t avgPeakMemoryDuringEncoding, size_t avgPeakMemoryDuringDecoding, double average_encoded_throughput, double average_decoded_throughput);
